...
const START_AT: Action<PkbAction> = MultipleActions(&[Custom(PkbAction::HoldCmd), d(3), k(Tab)]);
const END_AT: Action<PkbAction> = MultipleActions(&[Custom(PkbAction::ReleaseCmd), d(0)]);
...
pub static LAYERS: keyberon::layout::Layers<PkbAction> = &[
    &[
        ...
        &[k(VolUp),   k(VolDown),   k(LAlt),  l(1),       k(BSpace),  k(Enter),  k(LGui),            k(RGui),    k(RCtrl), k(Space),    l(2),        k(RAlt),   NEXT,       PREVIOUS],
    ], &[
        ...
        &[Trans,      k(Grave),     NoOp,     NoOp,       k(Minus),   k(Equal),  Trans,              START_AT,   NoOp,     k(LBracket), k(RBracket), NoOp,      NoOp,       Trans],
        ...
        &[Trans,      NoOp,         NoOp,     NoOp,       NoOp,       NoOp,      NoOp,               NoOp,       NoOp,     NoOp,        NoOp,        NoOp,      NoOp,       NoOp],
        &[Trans,      NoOp,         NoOp,     NoOp,       NoOp,       NoOp,      NoOp,               NoOp,       NoOp,     NoOp,        NoOp,        NoOp,      NoOp,       NoOp],
        &[Trans,      NoOp,         NoOp,     NoOp,       NoOp,       NoOp,      NoOp,               END_AT,     NoOp,     NoOp,        NoOp,        NoOp,      NoOp,       NoOp],
        &[Trans,      Trans,        Trans,    Trans,      Trans,      Trans,     Trans,              Trans,      Trans,    Trans,       Trans,       Trans,     k(Right),   k(Left)],
    ], 
];
